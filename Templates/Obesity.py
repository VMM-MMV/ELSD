...
class Obesity:
    def __init__(self, pregnancies: int = 0, glucose: float = 0, bloodPressure: float = 0, skinThickness: float = 0, insulin: float = 0, bmi: float = 0, diabetesPedigreeFunction: float = 0, age: float = 0, diagnosis = None):
        ...
        self.bmi = float(bmi)
        self.diabetesPedigreeFunction = float(diabetesPedigreeFunction)
        self.age = float(age)
